...
pub fn do_unstake(ctx: &mut StakePoolInfo, _rng: &mut Pcg32, root: &UserAccount, operator: &Operator, stakepooling :&ContractAccount<StakePooling>, pool :&ContractAccount<TestnStable>){
