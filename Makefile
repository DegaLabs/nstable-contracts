...
FARMING_DIR=nstable-farming-v2
FARMING_BUILDER_NAME=build_v2_nstable_farming
FARMING_RELEASE=nstable_farming_v2

EXCHANGE_DIR=nstable-exchange
EXCHANGE_BUILDER_NAME=build_nstable_exchange
EXCHANGE_RELEASE=nstable_exchange
